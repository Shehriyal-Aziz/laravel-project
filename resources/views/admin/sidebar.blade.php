...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="#">my web</a>
        <!-- Sidebar Toggle-->
                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseRecords" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                <a class="nav-link" href="/booked">Booked table</a>
...
@yield("admin")
    ...
    <script src="adminassets/demo/chart-area-demo.js"></script>
    <script src="adminassets/demo/chart-bar-demo.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/simple-datatables@7.1.2/dist/umd/simple-datatables.min.js"
        crossorigin="anonymous"></script>
    <script src="adminassets/js/datatables-simple-demo.js"></script>
</body>
